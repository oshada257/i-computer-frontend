...
export default function AddProductModal({ isOpen, onClose, onSuccess }) {
  ...
  const handleSubmit = async () => {
    if (!formData.productId || !formData.name || !formData.price || !formData.description) {
      alert("Please fill in all required fields: Product ID, Name, Price, and Description");
      return;
    }
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center">
            <input
              ...
              id="isVisible"
            />
            <label htmlFor="isVisible" className="ml-2 text-gray-700 font-medium">
